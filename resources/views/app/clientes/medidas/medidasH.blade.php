            ...
            <form>
                ...
                <div class="form-row">
                    ...
                    <div class="col-md-2 mb-3">
                        ...
                        <div class="input-group">
                            <input type="text" class="form-control" id="triceps" disabled
                                value="{{$medida->triceps_med}}">
                            <div class="input-group-append">
                                <span class="input-group-text">cm</span>
                            </div>
                        </div>
                    ...
                    <div class="col-md-2 mb-3">
                        ...
                        <div class="input-group">
                            <input type="text" class="form-control" id="cintura" disabled
                                value="{{$medida->cintura_med}}">
                            <div class="input-group-append">
                                <span class="input-group-text">cm</span>
                            </div>
                        </div>
                    ...
                    <div class="col-md-2 mb-3">
                        ...
                        <div class="input-group">
                            <input type="text" class="form-control" id="espalda" disabled
                                value="{{$medida->espaldaH_med}}">
                            <div class="input-group-append">
                                <span class="input-group-text">cm</span>
                            </div>
                        </div>
                ...
                <div class="form-row">
                    ...
                    <div class="col-md-2 mb-3">
                        ...
                        <div class="input-group">
                            <input type="text" class="form-control" id="pectoral" disabled
                                value="{{$medida->pectoralH_med}}">
                            <div class="input-group-append">
                                <span class="input-group-text">cm</span>
                            </div>
                        </div>
                ...
                <div class="form-row">
                    ...
                    <div class="col-md-2 mb-3">
                        ...
                        <div class="input-group">
                            <input type="text" class="form-control" id="muslo1" disabled
                                value="{{$medida->muslo1_med}}">
                            <div class="input-group-append">
                                <span class="input-group-text">cm</span>
                            </div>
                        </div>
                    ...
                    <div class="col-md-2 mb-3">
                        ...
                        <div class="input-group">
                            <input type="text" class="form-control" id="muslo2" disabled
                                value="{{$medida->muslo2_med}}">
                            <div class="input-group-append">
                                <span class="input-group-text">cm</span>
                            </div>
                        </div>
                    ...
                    <div class="col-md-2 mb-3">
                        ...
                        <div class="input-group">
                            <input type="text" class="form-control" id="pantorrilla" disabled
                                value="{{$medida->pantorrillas_med}}">
                            <div class="input-group-append">
                                <span class="input-group-text">cm</span>
                            </div>
                        </div>
